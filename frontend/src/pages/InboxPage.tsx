...
import { MessageCircle, Mail, Share2, Globe, AlertTriangle, Users, ShieldAlert } from 'lucide-react'
...
function CommunityCard({ opp }: { opp: CommunityOpportunity }) {
