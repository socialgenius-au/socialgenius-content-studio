...
const s: Record<string, CSSProperties> = {
  root: {},
  form: { background: '#fafaf8', border: '1px solid #e8e3d8', borderRadius: 8, padding: 12, marginBottom: 12 },
  sectionTitle: {
  ...
  numInput: { width: '100%', padding: '6px 8px', border: '1px solid #ddd', borderRadius: 5, fontSize: 12 },
  chipRow: { display: 'flex', flexWrap: 'wrap', gap: 4 },
  chip: { padding: '3px 7px', border: '1px solid #ddd', borderRadius: 10, fontSize: 11, cursor: 'pointer', background: '#fff', color: '#555' },
  chipActive: { background: '#1E3D2A', color: '#F5F0E8', borderColor: '#1E3D2A' },
  checkRow: { display: 'flex', alignItems: 'center', gap: 6, cursor: 'pointer', marginBottom: 10 },
  checkLabel: { fontSize: 12, color: '#555' },

  preview: {
    display: 'flex', alignItems: 'stretch', marginBottom: 10,
    background: '#1a1a1a', borderRadius: 6, overflow: 'hidden',
  },
  previewBar: { width: 4, flexShrink: 0 },
  previewText: { padding: '6px 10px', display: 'flex', flexDirection: 'column', gap: 1 },
  previewName: { color: '#fff', fontSize: 13, fontWeight: 800 },
  previewTitle: { color: '#aaa', fontSize: 11 },
  ...
  existingSection: {},
  ltCard: {
    display: 'flex', alignItems: 'center', background: '#fafaf8',
    border: '1px solid #e8e3d8', borderRadius: 6, padding: '6px 10px',
    marginBottom: 4, gap: 8,
  },
  ltCardBody: { flex: 1, display: 'flex', flexDirection: 'column', gap: 1 },
  ltName: { fontSize: 12, fontWeight: 700, color: '#1a1a1a' },
  ltTitle: { fontSize: 11, color: '#666' },
  ltMeta: { fontSize: 10, color: '#aaa' },
